...
export default function PredictDetail_Page({ params }: Props) {
                                        ...
                                        const aa = async () => {
                                            ...
                                            if (ctx) {
                                                ...
                                                img.onload = () => {
                                                    ...
                                                    templateData?.template_regions.forEach(
                                                        (s) => {
                                                            ctx.strokeRect(
                                                                s.sx,
                                                                s.sy,
                                                            ...
                                                            if (
                                                                s.template_marker_centers
                                                            ) {
                                                                s.template_marker_centers.forEach(
                                                                    (
                                                                        marker
                                                                    ) => {
                                                                        ctx.beginPath();
                                    ...
                                    <tbody>
                                        {sheet.predict_ans_result ? (
                                            ...
                                            <tr>
                                                <td
                                                    colSpan={4}
                                                    className="text-center border border-neutral-700 dark:border-neutral-400"
                                                >
                                                    ไม่มีข้อมูลการตรวจ
                                                </td>
                                            </tr>
                            ...
                            <table className="my-4">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="border border-neutral-700 dark:border-neutral-400 text-left px-3 py-1">
                                            {answerData.answer_details.reduce(
                                                (sum, answer) =>
                                                    sum + answer.point,
                                                0
                                            )}
        ...
        if (sheetData.predict_ans_result) {
            ...
            predictResults.forEach((shData, index) => {
                if (index < answerData.answer_details.length) {
                    ...
                    // สร้างสตริงเฉลย - แก้ไขการ parse JSON
                    let correctAnswer = "";
                    if (answerDetail.choice_correct) {
                        try {
                            ...
                            if (correctChoices.a) correctAnswer += "a ";
                            if (correctChoices.b) correctAnswer += "b ";
                            if (correctChoices.c) correctAnswer += "c ";
                            if (correctChoices.d) correctAnswer += "d ";
                            
                            correctAnswer = correctAnswer.trim();
                        } catch (error) {
                            console.error("Error parsing choice_correct:", error);
                            correctAnswer = answerDetail.choice_correct;
                        }
                    }
    ...
    const handleExportAll = (sheetData: SheetData[], type: "excel" | "csv") => {
        ...
        if (type === "csv") {
            XLSX.writeFile(wb, `Report_All_${groupData.name}.csv`, { bookType: "csv" });
        }
    };
            ...
            <div className="flex flex-col gap-2 container mx-auto">
                ...
                <table className="border-2">
                    <thead>
                        ...
                        <tr className="border">
                            <td className="text-center p-2">ชื่อ</td>
                        ...
                        {sheetData.map((sheet) => (
                            <tr key={sheet.id} className="border">
                                ...
                                <td className="text-center p-2">
                                    ...
                                    answerData.updated_at > sheet.updated_at
                                        ? "เฉลยมีการเปลี่ยนแปลง"
                                        : null}
                                </td>
                                <td className="text-center p-2">
                                    {sheet.predict_std_fill_result
